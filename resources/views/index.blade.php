                            ...
                            <ul class="navbar-nav navbar-nav-hover ms-lg-12 ps-lg-5 w-100">
                                ...
                                <li class="nav-item my-auto ms-3 ms-lg-0">
                                    <a href="https://www.creative-tim.com/builder?ref=navbar-soft-design-system"
                                        class="btn btn-sm btn-outline-dark btn-round mb-0 me-1 mt-2 mt-md-0">Online
                                        Builder</a>
                                </li>
                                <li class="nav-item my-auto ms-3 ms-lg-0">

                                    <a href="https://www.creative-tim.com/product/soft-ui-design-system-pro"
                                        class="btn btn-sm text-white  bg-dark  btn-round mb-0 me-1 mt-2 mt-md-0">Upgrade
                                        to Pro</a>
                ...
                <div class="col-12">
                    <div class="text-center">
                        <p class="my-4 text-sm">
                            ...
                            </script> {{ config('app.name') }} <a href="https://www.tekadesa.com"
                                target="_blank">{{ config('app.author') }}</a>.
                        </p>
                    </div>
                </div>
            </div>

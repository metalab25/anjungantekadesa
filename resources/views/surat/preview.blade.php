...
@section('content')
    <div class="container-fluid d-flex flex-column py-4" style="height: 100vh;">
        <div class="flex-grow-1">
            <iframe id="previewPdf"
                src="{{ route('layanan.surat.preview', ['id' => $id, 'inline' => 'true']) }}#toolbar=0&navpanes=0&scrollbar=0"

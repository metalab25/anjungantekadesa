<div class="card-header pb-0 text-left">
    ...
    <a href="{{ route('login.nik') }}"
        class="btn btn-lg bg-gradient-primary border-radius-xl btn-lg w-100 mt-4 mb-0">Login Dengan NIK</a>
    <p class="my-2">- Atau -</p>
    <a href="{{ route('login.ktp') }}" class="btn btn-lg bg-gradient-success border-radius-xl btn-lg w-100 mb-3">Login
        Dengan Scan KTP</a>
</div>
